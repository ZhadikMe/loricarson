...
'<embed name="'+this.config.fid+'" id="'+this.config.fid+'" src="'+this.config.swf+'"';d+=' width="'+this.config.width+'" height="'+this.config.height+'" bgcolor="'+this.config.bgcolor+'"';d+=' quality="high" FlashVars="id='+escape(this.config.id)+"&fid="+escape(this.config.fid)+"&vol="+this.config.volume+'"';d+=' allowScriptAccess="always"';d+=' type="application/x-shockwave-flash" pluginspage="https://web.archive.org/web/20140809193121/http://www.macromedia.com/go/getflashplayer" />';this.element.html(d)}else this.element.html("<p>Flash 8 or above is not installed. <a href='https://web.archive.org/web/20140809193121/http://get.adobe.com/flashplayer'>Get Flash!</a></p>");
...
/*
     FILE ARCHIVED ON 19:31:21 Aug 09, 2014 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 14:40:27 Apr 02, 2026.
...
playback timings (ms):
  ...
  esindex: 0.007
  cdx.remote: 60.865
  LoadShardBlock: 401.618 (3)
  PetaboxLoader3.datanode: 909.145 (5)
  load_resource: 781.749 (2)
  PetaboxLoader3.resolve: 224.706 (2)
*/